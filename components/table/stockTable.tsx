...
const Tabs: React.FC<TabsProps> = ({ tabs }) => {
  ...
  const [adjustQuantityModal, setAdjustQuantityModal] =
  ...
  const handleSearchProduct = async (productName: string) => {
    ...
    allProducts = await getAllProduct();
    const newrows = allProducts?.filter(
      (product) =>
  ...
  return (
    <div className="w-full">
      ...
      >
        <form
          ref={formRefAddProduct}
          onSubmit={() => {
            handleaddProduct(formRefAddProduct, gros);
          }}
        ...
        >
          <div className="w-3/4  bg-white rounded-2xl flex-col max-h-screen overflow-y-auto">
            ...
            >
              Please enter the information of the added product
            </div>

            <div className={clsx("p-5 w-full", !AddProductpopup && "hidden")}>
              <div className="w-full flex justify-evenly">
                <div className="m-1 text-2xl w-1/2">Product Code:</div>
                <input
              ...
              <div className="w-full flex justify-evenly">
                <div className="m-1 text-2xl w-1/2">Supplier:</div>
                <select
                  name="supplier_id"
                  className="m-1 border-2 border-gray-300 rounded-lg p-0.5 w-1/2"
                >
              ...
              <div className="w-full flex justify-evenly">
                <div className="m-1 text-2xl w-1/2">Product Name:</div>
                <input
                  name="product_name"
                  type="text"
                  className="m-1 border-2 border-gray-300 rounded-lg p-0.5 w-1/2"
              ...
              <div className="w-full flex justify-evenly">
                <div className="m-1 text-2xl w-1/2">Product quantity:</div>
                <input
              ...
              <div className="w-full flex justify-evenly">
                <div className="m-1 text-2xl w-1/2">Product unit price:</div>
                <input
                  name="product_price"
                  type="text"
                  className="m-1 border-2 border-gray-300 rounded-lg p-0.5 w-1/2"
              ...
              <div className="w-full flex justify-evenly">
                <div className="m-1 text-2xl w-1/2">Product cost:</div>
                <input
                  name="product_cost"
                  type="text"
                  className="m-1 border-2 border-gray-300 rounded-lg p-0.5 w-1/2"
              ...
              <div className="w-full flex justify-evenly">
                <div className="m-1 text-2xl w-1/2">Product gros:</div>
                <input
                  type="checkbox"
                  checked={gros}
                  onChange={() => {
              ...
              >
                <div className="m-1 text-2xl w-1/2">Product unité Code:</div>
                <input
                  name="product_barcode_for_variant"
                  type="text"
                  className="m-1 border-2 border-gray-300 rounded-lg p-0.5 w-1/2"
                  onKeyDown={handleKeyDownForm}
                />
              ...
              >
                <div className="m-1 text-2xl w-1/2">
                  Product unité quantity in package:
                </div>
                <input
                  name="product_quantity_for_variant"
                  type="text"
                  className="m-1 border-2 border-gray-300 rounded-lg p-0.5 w-1/2"
                  onKeyDown={handleKeyDownForm}
                />
      ...
      >
        <div className="w-1/2 bg-white rounded-2xl flex-col">
          ...
          >
            Please enter the quantity of the product you want to add
          </div>
          ...
          <div className={clsx("p-5 w-full", !AddQuantitypopup && "hidden")}>
            ...
            <div className="w-full flex justify-evenly">
              <div className="m-1 text-2xl w-1/2">Product old cost:</div>
              <input
                type="text"
                className="m-1 border-2 border-gray-300 rounded-lg p-0.5 w-1/2"
              />
            ...
            <div className="w-full flex justify-evenly">
              <div className="m-1 text-2xl w-1/2">Product new cost:</div>
              <input
                type="text"
                className="m-1 border-2 border-gray-300 rounded-lg p-0.5 w-1/2"
              />
          ...
          <div className="flex justify-center p-3">
            <button
              ...
              onClick={() => setAddQuantitypopup(false)}
            >
              Add
            </button>
            <button
      ...
      >
        <div className="w-1/2 bg-white rounded-2xl flex-col">
          ...
          <div
            className={clsx("p-5 w-full", !AddQuantitypopup && "hidden")}
          ></div>
          ...
          <div className="flex justify-center p-3">
            ...
            <button
              ...
              onClick={() => setSavePricepopup(false)}
            >
              Cancel
            </button>
          </div>
      ...
      >
        <div className="w-1/2 bg-white rounded-2xl flex-col">
          ...
          <div
            className={clsx("p-5 w-full", !DeleteProductpopup && "hidden")}
          ></div>
          <div className="flex justify-center p-3">
            <button
              className={clsx(
      ...
      <div>
        ...
        <div className="flex justify-between w-full p-4">
          ...
          <MybuttonSearch
            ...
            placeholderText="le nom / le code du produit"
        ...
        <div className="pl-3 pb-2 pr-0 pt-2 bg-[#EBEBEB] rounded-2xl w-full max-h-72 overflow-y-scroll">
          ...
          {rows?.map((row, index) => (
            <div key={index} className="text-center flex">
              ...
              <div
                className={clsx("basis-1/5 flex align-middle justify-center")}
              >
                <div>{row.code}</div>
              </div>
              ...
              <div className="basis-1/5 flex align-middle justify-center">
                {isEditable && EditIndex == index ? (
                  <input
                    ...
                    onChange={(e) =>
                      handlePriceyChange(index, parseInt(e.target.value) || 0)
                    }
                  ></input>
                ) : (
                  row.unitPrice
